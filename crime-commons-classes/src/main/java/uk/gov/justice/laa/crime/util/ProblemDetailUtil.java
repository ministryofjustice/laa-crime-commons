...
public final class ProblemDetailUtil {
     ...
     * @param status HttpStatus Http Error encountered, as per <a href="https://www.rfc-editor.org/rfc/rfc9457#name-status">RFC-9457 - status</a>
     * @param detail String Details the error encountered, as per <a href="https://www.rfc-editor.org/rfc/rfc9457#name-detail">RFC-9457 - detail</a>
     * @param extension ErrorExtension holding additional details of the error.
     * @return ProblemDetail populated with given details
     */
    public static ProblemDetail buildProblemDetail(HttpStatus status, String detail, ErrorExtension extension) {
     ...
     *
     * @param status    String as per <a href="https://www.rfc-editor.org/rfc/rfc9457#name-status">RFC-9457 - status</a>
     * @param title     String as per <a href="https://www.rfc-editor.org/rfc/rfc9457#name-title">RFC-9457 - title</a>
     * @param type      URI as per <a href="https://www.rfc-editor.org/rfc/rfc9457#name-type">RFC-9457 - type</a>
     * @param detail    String as per <a href="https://www.rfc-editor.org/rfc/rfc9457#name-detail">RFC-9457 - detail</a>
     * @param instance  URI as per <a href="https://www.rfc-editor.org/rfc/rfc9457#name-instance">RFC-9457 - instance</a>
     * @param extension ErrorExtension holding additional details of the error.
     * @return ProblemDetail populated with given values.
     */
    public static ProblemDetail buildProblemDetail(HttpStatus status, String title, URI type, String detail, URI instance, ErrorExtension extension) {
     ...
     * @param status    String as per <a href="https://www.rfc-editor.org/rfc/rfc9457#name-status">RFC-9457 - status</a>
     * @param title     String as per <a href="https://www.rfc-editor.org/rfc/rfc9457#name-title">RFC-9457 - title</a>
     * @param type      URI String as per <a href="https://www.rfc-editor.org/rfc/rfc9457#name-type">RFC-9457 - type</a>
     * @param detail    String as per <a href="https://www.rfc-editor.org/rfc/rfc9457#name-detail">RFC-9457 - detail</a>
     * @param instance  URI String as per <a href="https://www.rfc-editor.org/rfc/rfc9457#name-instance">RFC-9457 - instance</a>
     * @param extension ErrorExtension for holding additional details of the error.
     */
    public static ProblemDetail buildProblemDetail(HttpStatus status, String title, String type, String detail, String instance, ErrorExtension extension) {
        return buildProblemDetail(status, title, URI.create(type), detail, URI.create(instance), extension);
    }
